...
config_header = Struct("header",
    ...
    Bool32("extraction_flags",
        ...
        "generate_comp_verts",
        Pad(3),
        {"NAME": "use_tag_index_for_script_names", "DEFAULT": True},
        {"NAME": "use_scenario_names_for_script_names", "DEFAULT": True},
...
paths = Array("paths",
    ...
    NAME_MAP=("last_dir", "tagslist_path", "tags_dir", "data_dir", "root_dir_prefix"),
    VISIBLE=False
    )
